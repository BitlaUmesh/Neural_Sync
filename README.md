...
<video src="https://github.com/BitlaUmesh/Neural_Sync/releases/download/v1.0-demo/demo.mp4" controls="controls" style="max-width: 100%; display: block; margin: 0 auto;">
